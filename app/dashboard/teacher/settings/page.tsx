...
import { BarChart3, Users, Settings, Upload, Loader2 } from "lucide-react"
...
export default function TeacherSettingsPage() {
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const uploadPreset = "Proyecto_Imp" // Asegúrate de que este preset sea 'Unsigned' en Cloudinary
      ...
      // Actualizar en Supabase y estado global
      await api.updateUser(user.id, { avatar_url: imageUrl })
      setUser({ ...user, avatar: imageUrl })
      
    } catch (error) {
      console.error("Error al subir avatar:", error)
      alert("No se pudo subir la foto. Revisa la consola para más detalles.")
    } finally {
